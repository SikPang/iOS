...
//커피메뉴
private let names: Array<String> = ["앗메리카노",
                            "원조커피",
                            "바닐라라떼",
                            "블랙펄 카페라떼",
                            "더블에스프레소",
                            ...
                            "코코넛커피스무디",
                            "코코넛라떼"]
private let prices: Array<String> = ["HOT : 1,500\nICED : 2,000",
                               "HOT : 2,000\nICED : 2,500",
                               "HOT : 3,000\nICED : 3,500",
                               "ICED : 3,500",
                               "HOT : 1,500",
                               ...
                               "ICED : 4,000",
                               "ICED : 3,800"]
private let images: Array<String> = ["http://paikdabang.com/wp-content/uploads/2018/05/%EC%95%97%EB%A9%94%EB%A6%AC%EC%B9%B4%EB%85%B8-1.jpg",
...
private let messages: Array<String> = ["빽다방만의 맛과 향을 더한 100% 아라비카 로스팅 원두로 뽑아내 깊고 진한 맛의 앗!메리카노",
