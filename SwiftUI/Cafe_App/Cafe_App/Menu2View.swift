...
private let names: Array<String> = [
    ...
    "망고요거트스무디",
    "딸기요거트스무"]
private let prices: Array<String> = ["HOT : 3,000\nICED : 3,500",
                               "ICED : 3,500",
                               "ICED : 3,500",
                               "HOT : 3,000\nICED : 3,500",
                               "HOT : 3,000\nICED : 3,000",
...
private let images: Array<String> = ["http://paikdabang.com/wp-content/uploads/2018/05/%EC%99%84%EC%A0%84%EC%B4%88%EC%BD%94.jpg",
...
private let messages: Array<String> = ["초코에 퐁당 빠지고 싶을때~!? 진짜~! 다크초콜렛이 올라간 완~전 진한 초코라떼",
